...
при установке битрейта он продолжает работать на старом до перезагрузки
установка стоп бита тоже применяется после перезагрузки
*/
