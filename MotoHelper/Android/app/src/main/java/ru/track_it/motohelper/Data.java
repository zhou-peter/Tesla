...
public class Data {
    ...
    public static final int pointsCountToShowOnGraph = 50; //0.5s

    public static final int accelDataResolutionBits = 10;
    public static final int maxAccel = 1<<(accelDataResolutionBits+1);
